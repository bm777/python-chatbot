...
unigramDict = {}
synonyms_map = {}
path = "chatbot_app/train.txt"
path1 = "chatbot_app/vocab.txt"
path2 = "chatbot_app/synonyms.txt"
...
if __name__ == "__main__":
    #main()
    st = True
    print("Write something or type 'q' to quit :)")
    while st:
        print("==================================")
        querry = input("Write something ...")
        if querry == "q":
            ft = False
        else:
            process_NL(querry)
